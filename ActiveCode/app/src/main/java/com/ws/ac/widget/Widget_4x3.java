 ...
 */
public class Widget_4x3 extends AppWidgetProvider {
    ...
    private PendingIntent getPendingIntent(Context context,int resID){
        ...
        intent.setClass(context, Widget_4x3.class);
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        ComponentName componentName = new ComponentName(context, Widget_4x3.class);
        // 更新appwidget
